...
$pathToModels = "../MSPC_CRUD20231225.crats/src/Admin/Generated/Models/"+$nameContext
$pathToContext= "../MSPC_CRUD20231225.crats/src/Admin/Generated/DB/"+$nameContext
...
function Generate{
 ...
 Generate "Models"  "../MSPC_CRUD20231225.Models/Generated/" $project

 Generate "Context"  "../MSPC_CRUD20231225.Context/Generated/" $project

 Generate "Controllers"  "../MSPC_CRUD20231225.Controllers/Generated/" $project 

# Generate "crats"  "../MSPC_CRUD20231225.crats/src/Admin/Generated/" $project

# Generate "angular"  "../ExampleAngular/src/app/Admin/Generated/" $project

Generate "blazorList"  "../MSPC_CRUD20231225.Blazor/Pages/Generated/" $project 

Generate "blazorRow"  "../MSPC_CRUD20231225.Blazor/Pages/Generated/" $project 

#blazor do not admit lowercase razor files
$TextInfo = (Get-Culture).TextInfo
get-childitem -Recurse ../MSPC_CRUD20231225.Blazor/Pages/Generated/ -Filter *.razor | foreach { $NewName = $TextInfo.ToTitleCase($_); ren $_.FullName $NewName }
return
